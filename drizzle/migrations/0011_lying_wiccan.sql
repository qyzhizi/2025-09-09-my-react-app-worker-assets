...
INSERT INTO `__new_github_access`("id", "user_id", "branch", "github_repo_name", "vault_path_in_repo", "access_token", "access_token_expires_at", "refresh_token", "refresh_token_expires_at", "github_user_name", "vault_name") SELECT "id", "user_id", "branch", "github_repo_name", "vault_path_in_repo", "access_token", "access_token_expires_at", "refresh_token", "refresh_token_expires_at", "github_user_name", "vault_name" FROM `github_access`;--> statement-breakpoint
