/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: af4af973b125ad651be1985bad953eae)
// Runtime types generated with workerd@1.20250902.0 2026-04-24 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ACCESS_TOKEN_SECRET: "2a579cb67f0ce7220b9fe4f88698e3931c3929f0bae07ca520489f44f15ff004";
		REFRESH_TOKEN_SECRET: "08d0727fee3971c39441d64493573c5ef957c96a51b1cea7605577287fc09557";
		ACCESS_TOKEN_EXPIRY: "300";
		REFRESH_TOKEN_EXPIRY: "604800";
		CONSUMER_API_KEY: "2a579cb67f0ce7220b9fe4f88698e3931c3929f0bae07ca520489f44f15ff004";
		MEMOFLOW_WORKER_URL: "https://worker-assets-durableobject.lepton.workers.dev";
		GITHUB_ID: string;
		GITHUB_SECRET: string;
		GITHUB_APP_CLIENT_ID: string;
		GITHUB_APP_CLIENT_SECRETS: string;
		GITHUB_APP_URL: string;
		GITHUB_APP_ID: string;
		GITHUB_APP_PRIVATE_PEM: string;
		MY_DURABLE_OBJECT: DurableObjectNamespace<import("./worker/index").MyDurableObject>;
		DB: D1Database;
		memoflow_worker: Fetcher /* memoflow_worker */;
		MEMOFLOW_INDEX_0: VectorizeIndex;
		MEMOFLOW_INDEX_1: VectorizeIndex;
		MEMOFLOW_INDEX_2: VectorizeIndex;
		MEMOFLOW_INDEX_3: VectorizeIndex;
		MEMOFLOW_INDEX_4: VectorizeIndex;
		MEMOFLOW_INDEX_5: VectorizeIndex;
		MEMOFLOW_INDEX_6: VectorizeIndex;
		MEMOFLOW_INDEX_7: VectorizeIndex;
		MEMOFLOW_INDEX_8: VectorizeIndex;
		MEMOFLOW_INDEX_9: VectorizeIndex;
		AI: Ai;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_TOKEN_SECRET" | "REFRESH_TOKEN_SECRET" | "ACCESS_TOKEN_EXPIRY" | "REFRESH_TOKEN_EXPIRY" | "CONSUMER_API_KEY" | "MEMOFLOW_WORKER_URL" | "GITHUB_ID" | "GITHUB_SECRET" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_CLIENT_SECRETS" | "GITHUB_APP_URL" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_PEM">> {}
}
